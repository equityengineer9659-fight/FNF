/* ============================================
   Stats Counter Fix - Ensures number animations work
   Updated to handle suffix display
   ============================================ */
...
(function() {
    ...
    class StatsCounterFix {
        ...
        setupObserver() {
            ...
            const impactSection = document.querySelector('#impact-heading')?.closest('section');
            if (impactSection) {
        ...
        animateCounters() {
            ...
            this.counters.forEach((counter, index) => {
                ...
                counter.setAttribute('data-original-suffix', suffix);
        ...
        animateValue(element, start, end, duration, suffix) {
            ...
            const updateCounter = (currentTime) => {
                ...
                // Update just the number, not the suffix
