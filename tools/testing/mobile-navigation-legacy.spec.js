...
/**
 * LEGACY MOBILE NAVIGATION TESTS FROM /tests/ DIRECTORY
 * Preserved for reference - main tests are in mobile-navigation.spec.js
...
test.describe('LEGACY: Mobile Navigation Critical Safety Tests', () => {
  ...
  for (const pageInfo of pages) {
    test(`Mobile navigation toggle works on ${pageInfo.url}`, async ({ page }) => {
      ...
      // Menu should now be open (has nav-show class)
